...
const Calendar = ({ startDayOfWeek }: CalendarProps) => {
  ...
  if (startDayOfWeek === "monday") {
    ...
    startDay =
      firstDateOfMonthObj.day() === 0 ? 6 : firstDateOfMonthObj.day() - 1;
  ...
  const prevMonth = () =>
    setDateObj((prevDateObj) => prevDateObj.subtract(1, "month"));
  const nextMonth = () =>
    setDateObj((prevDateObj) => prevDateObj.add(1, "month"));
